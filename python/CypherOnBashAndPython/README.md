...
Лабораторная работа по курсу **«Скрипты на Bash и Python»**.  
...
Сдвиг K=3:    d e f g h i j k l m n o p q r s t u v w x y z a b c
```
...
<p align="center">
  <img src="./assets/cipher.gif" alt="Caesar cipher live encoding" width="680"/>
</p>
...
<p align="center">
  <img src="./assets/terminal.gif" alt="Terminal run animation" width="680"/>
</p>
...
├── assets/
│   ├── cipher.gif       # анимация шифрования символов
│   └── terminal.gif     # анимация запуска скрипта
└── README.md
```
...
<p align="center">
  <img src="./assets/help.gif" alt="Help output animation" width="680"/>
</p>

**Пример ошибки при неверном вводе:**

<p align="center">
  <img src="./assets/error.gif" alt="Error output animation" width="680"/>
</p>
