...
> 🎬 [Посмотреть анимацию шифрования](./assets/cipher.html)
...
> 🎬 [Посмотреть анимацию обхода файлов](./assets/terminal.html)
...
├── assets/
│   ├── terminal.html    # анимация запуска скрипта
│   └── cipher.html      # анимация шифрования символов
└── README.md
```
